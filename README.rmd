...
<!-- badges: start -->
[![CRAN Status Badge](https://www.r-pkg.org/badges/version/aesopR)](https://cran.r-project.org/package=aesopR)
...
A tibble containing 147 public-domain fables with:
	•	fable_id
	•	title
	•	full_text
	•	moral
...
The package also includes sentiment-enriched token datasets using built-in tidytext lexicons:
	•	aesops_afinn
	•	aesops_bing
...
Many NLP examples rely on song lyrics or copyrighted material.
aesopR provides a fully public-domain corpus suitable for:
