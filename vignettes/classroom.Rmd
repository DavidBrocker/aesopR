...
Aesop’s fables are short, narrative, and structured around morals—which makes them unusually good for research methods teaching:

-   **Operationalization:** “What counts as sentiment?” “What counts as a theme?”

-   **Measurement decisions:** Tokenization, stop words, lexicon choice

-   **Transparency & replication:** Same corpus, different pipelines, different conclusions
...
**Goal:** Show how conclusions depend on what evidence you allow yourself to see.
...
**Goal:** Demonstrate that measurement depends on instrument choice (lexicon choice).

**Quick prompt (students):**

-   Do these methods agree about whether the fable is “positive” or “negative”?
...
**Goal:** Have students define a construct (e.g., “frustration” or “self-justification”)
...
Below is a simple, transparent “dictionary method” that students can critique.
